...
public class Redirect2WebReceived extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Redirect2WebReceived() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(u.getuId()!=0 && u.getState()!=0)
		{
			...
			request.getRequestDispatcher("ReceivedOrderUI?openId="+ token.getOpenId()).forward(request,response);
		}
		else
		{
