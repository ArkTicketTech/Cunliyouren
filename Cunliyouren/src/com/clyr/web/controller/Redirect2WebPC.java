...
public class Redirect2WebPC extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Redirect2WebPC() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(u.getuId()!=0 && u.getState()!=0)
		{
			...
			request.getRequestDispatcher("PersonalCenterUI?openId="+ token.getOpenId()).forward(request,response);
		}
		else
		{
