...
<html>
  ...
  <body bgcolor="#ffffff">
    ...
    <form method="post" name="form1" style="width:100%;height:73%" action="UserRegister">
    	...
    	<p>您的家乡</p>
    	<select id="s_province" name="province" style="width:17%;float:left;margin:3% 1%;padding:4% 1%;font-size:2vw"></select>
    	<select id="s_city"  name="city" style="width:17%;float:left;margin:3% 1%;padding:4% 1%;font-size:2vw"></select>
    	<select id="s_county"  name="country" style="width:17%;float:left;margin:3% 1%;padding:4% 1%;font-size:2vw"></select>
    	...
    	<input type="submit" value="提交" style="width:20%;;height:8vw;float:right;margin-right:8%;margin-top:8%;font-size:5vw">
    </form>
  </body>
</html>
