...
<html>
  ...
  $(document).ready(function(){
  	...
  	$.each(receivedOrder,function(idx,item){
 		...
 		var p_div_price=$("<div style='color:#FF0000;width:50%;height:0;padding-bottom:7%;float:left;font-size:3vw'>"+"手机号:"+item.telNum+"</div>");
  ...
  <body bgcolor="#ffffff">
    <div align="center" style="width:40%;padding:5% 1%;background-color:#ffffff;border:1px solid black;margin-left:30%;font-size:4vw;background-color:#ccff99">我收到的购买请求</div>
